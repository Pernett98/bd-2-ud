...
ALTER TABLE CONDUCTORES ADD CONSTRAINT CONDUCTORES_NOMBRE_NN ( OBJ_PER_CONDUCTOR.NOMBRE IS NOT NULL );
ALTER TABLE CONDUCTORES ADD CONSTRAINT CONDUCTORES_APELLIDO_NN ( OBJ_PER_CONDUCTOR.APELLIDO_1 IS NOT NULL );
...
CREATE TABLE USUARIOS
  (
    ...
    OBJ_PERSONA_USUARIO OBJ_PERSONA NOT NULL
  ) ;
...
ALTER TABLE CONDUCTORES ADD CONSTRAINT USUARIOS_NOMBRE_NN ( OBJ_PERSONA_USUARIO.NOMBRE IS NOT NULL );
ALTER TABLE CONDUCTORES ADD CONSTRAINT USUARIOS_APELLIDO_NN ( OBJ_PERSONA_USUARIO.APELLIDO_1 IS NOT NULL );
